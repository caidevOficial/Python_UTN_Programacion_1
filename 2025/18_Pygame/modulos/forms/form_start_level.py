...
def restart_level(dict_form_Data: dict):
    print('========== REINICIANDO NIVEL ==========') 
    dict_form_Data['level'] = nivel_cartas.inicializar_nivel_cartas(dict_form_Data.get('jugador'), dict_form_Data.get('screen'), dict_form_Data.get('level_number'))
    
    print('========== REINICIANDO DATOS NIVEL ==========')
    nivel_cartas.reiniciar_nivel(dict_form_Data.get('nivel'), dict_form_Data.get('jugador'), dict_form_Data.get('screen'))
    
    print('========== barajando mazos a jugadores ==========')
    nivel_cartas.barajar_mazos(dict_form_Data['level'])
